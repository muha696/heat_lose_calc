...
class PipeSystemApp:
    ...
    def export_to_excel(self):
        data_to_excel = {
            ...
            'Диаметр трубы, мм': [],
            'Тип прокладки': [],
            'Температура прямой воды на входе в участок, °C': [],
            'Температура прямой воды на выходе из участка, °C': [],
        ...
        for i in range(len(self.l_series)):
            ...
            data_to_excel['Длина участка, м'].append(self.l_series[i])
            ...
            data_to_excel['Температура прямой воды на входе в участок, °C'].append(self.tp_list[i][0])
            data_to_excel['Температура прямой воды на выходе из участка, °C'].append(self.tp_list[i][1])
